...
## Tech Stack
[![image](https://skillicons.dev/icons?perline=6&theme=dark&i=python,html,css,js,php,vue,bootstrap,laravel,vscode,phpstorm,ps,ai,pr,figma,notion,mysql,github,git,docker,linux,react,tailwind,pinia,java)](https://skillicons.dev)
